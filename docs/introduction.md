...
- Shaligo: A JavaScript wrapper for the Metron Comic Book Database's API.
- Kurin: A C# client library for the Metron Comic Book Database's API.
- Trok: A .NET library for reading and writing MetronInfo.xml files.
